            ...
            <div class="contact-section">
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-md-offset-6">
                            <p>Product Name: <?php echo $productDetails -> getProductName(); ?></p>
                            <p>Product Category: <?php echo $productDetails -> getProductCategory(); ?></p>
                            <p>Product Price: <?php echo $productDetails -> getProductPrice(); ?></p>
                            <p>Product Quantity: <?php echo $productDetails -> getProductQuantity(); ?></p>
                            <p>Product Stock: <?php echo $productDetails -> getProductStock(); ?></p>
                            <p>Product Description: <?php echo $productDetails -> getProductDescription(); ?></p>
                        </div>
                    </div>
                </div>
            </div>
