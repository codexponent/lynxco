            ...
            <div class="row">
              ...
              <div class="col-md-6 col-md-offset-2">
                <form class="form-horizontal" method="POST" action="customer.php">
                  ...
                  <div class="form-group">
                    <input type="checkbox" name="termsandconditions" value="okay">I agree to the terms and conditions<br>
                  </div>
                  <div class="form-group">
                    <!-- captcha -->
...
if (isset($_POST['loginSubmit'])){
    ...
    if ($securimage->check($_POST['captcha_code']) == false) {
      ...
      echo "<script>alert('Registration Successful')</script>";
        ...
        $emailProcess = new RegisterMailSender($registerEmail, $registerName, $registerPassword);
