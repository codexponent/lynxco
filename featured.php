  ...
  <header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url('img/aboutImage.jpg')">
        ...
        <div class="carousel-item" style="background-image: url('img/bgImage.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <h3>LynxCo</h3>
            <p>Online Clothing Store.</p>
          </div>
        ...
        <div class="carousel-item" style="background-image: url('img/contactImage.jpg')">
          <div class="carousel-caption d-none d-md-block">
            <h3>LynxCo</h3>
            <p>Online Clothing Store.</p>
          </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-5">
        ...
        <div class="ih-item circle effect1">
          <a href="#">
            ...
            <div class="img"><img src="img/aboutImage.jpg" alt="img"></div>
            <div class="info">
              <div class="info-back">
                <h3>LynxCo</h3>
                <p>Clothing Store</p>
      ...
      <div class="col-sm-5">
        ...
        <div class="ih-item circle colored effect1">
          <a href="#">
            <div class="spinner"></div>
            <div class="img"><img src="img/bgImage.jpg" alt="img"></div>
            <div class="info">
              <div class="info-back">
                <h3>LynxCo</h3>
                <p>Clothing Store</p>
